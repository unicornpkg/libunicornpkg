...
local function install_gist(package_table)
	...
	for k,v in pairs(package_table.instdat.filemaps) do
		...
		local http_data = unicorn.util.smartHttp("https://gist.githubusercontent.com/" .. package_table.instdat.repo_owner .."/"..  package_table.instdat.repo_name .."/raw/"..package_table.repo_ref.."/"..k)
		unicorn.util.fileWrite(http_data, v)
	end
end
